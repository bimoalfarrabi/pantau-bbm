    ...
    <div class="mx-auto max-w-[1280px] px-5 py-10">
      ...
      <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-6">
        <form class="grid gap-4 md:grid-cols-[1fr_220px_220px_auto]" @submit.prevent="submitFilters">
          ...
          <button type="submit" class="mt-2 rounded-full bg-slate-950 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-slate-800 md:mt-6">Filter</button>
        </form>
