...
Route::get('/about', function (SettingRepository $settings) {
    ...
    return Inertia::render('About', [
        ...
        'aboutContent' => [
            ...
            'sourcesTitle' => $settings->get('about.sources.title', 'Sources & Credits'),
            'sourceOneTitle' => $settings->get('about.source_one.title', 'Bensin API'),
            'sourceOneDescription' => $settings->get('about.source_one.description', 'Sumber utama harga BBM yang dipakai untuk sinkronisasi data dan pembaruan tampilan.'),
            'sourceOneLinkLabel' => $settings->get('about.source_one.link_label', 'Buka link'),
            'sourceOneUrl' => $settings->get('about.source_one.url', ''),
            'sourceTwoTitle' => $settings->get('about.source_two.title', 'Open Source Stack'),
            'sourceTwoDescription' => $settings->get('about.source_two.description', 'Dibangun dengan Laravel, Tailwind CSS, dan komponen frontend yang ringan supaya pengalaman tetap konsisten.'),
            'sourceTwoLinkLabel' => $settings->get('about.source_two.link_label', 'Buka link'),
            'sourceTwoUrl' => $settings->get('about.source_two.url', ''),
            'sourceThreeTitle' => $settings->get('about.source_three.title', 'Disclaimer'),
            'sourceThreeDescription' => $settings->get('about.source_three.description', 'PantauBBM adalah platform independen dan bukan situs resmi Pertamina atau pemerintah Indonesia.'),
            'sourceThreeLinkLabel' => $settings->get('about.source_three.link_label', 'Buka link'),
            'sourceThreeUrl' => $settings->get('about.source_three.url', ''),
        ],
        'seo' => [
